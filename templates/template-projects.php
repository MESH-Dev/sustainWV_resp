...
<section id="content" class="nine columns interior projects">
			<div class="gutter clearfix">
				...
				<?php } } ?>
					<div class="gutter clearfix">
						<div id="topicsList">
							<select id="topics" data-cpt="project" class="project">
						...
						<div id="filterList">
	            			<ul id="filters" class="impact" data-cpt="project">
	            				<li><a data-filter="" class="active">All</a></li>
	            				<?php
	            					$terms = get_terms('Impact', 'orderby=date&hide_empty=0');
		            				$count = count($terms);
		            				if($count > 0){
		            					foreach($terms as $term){
